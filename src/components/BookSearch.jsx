...
const BookSearch = () => {
  ...
  return (
    ...
    <form onSubmit={handleSearch} className="flex">
      ...
      <button
        type="submit"
        className="bg-blue-500 text-white rounded-r-md px-4 py-2 ml-2 hover:bg-pink-400 focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:ring-opacity-50"
      >
        Search
      </button>
    </form>
